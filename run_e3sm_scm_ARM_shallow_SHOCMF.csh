...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename e3sm_scm_ARM_shallow
...
# Case specific information kept here
  ...
  set stop_n = 14
  set iop_file = ARM_shallow_iopfile_4scam_30min.nc #IOP file name 
# End Case specific stuff here

  # Location of IOP file
  #set iop_path = atm/cam/scam/iop
  set iop_path = /global/homes/m/$user/
...
# CAM configure options.  By default set up with settings the same as E3SMv1
  if ($code_tag == scream) then
    set CAM_CONFIG_OPTS="-phys cam5 -scam -shoc_sgs -microphys mg2 -nlev 72"
  else  
